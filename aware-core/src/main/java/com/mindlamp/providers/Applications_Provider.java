...
/**
 * LAMP Applications Content Provider Allows you to access all the recorded
 * applications on the database Database is located at the SDCard :
 * /LAMP/applications.db
 *
 * @author denzil
 */
public class Applications_Provider extends ContentProvider {
     ...
     */
    public static String AUTHORITY = "com.mindlamp.provider.applications";
