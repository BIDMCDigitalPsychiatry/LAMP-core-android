...
import com.mindlamp.Barometer;
import com.mindlamp.utils.DatabaseHelper;

import java.util.HashMap;

/**
 * LAMP Content Provider Allows you to access all the recorded sensor readings
 * on the database Database is located at the SDCard : /LAMP/gravity.db
 *
 * @author denzil
 */
