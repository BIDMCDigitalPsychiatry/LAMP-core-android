...
public class Http {
	...
	/**
	 * Logging tag (default = "LAMP")
	 */
	private String TAG = "LAMP::HTML";
	...
	public String dataPOST(final String url, final Hashtable<String, String> data, final boolean is_gzipped) {
		...
		try{
            ...
            if (Lamp.DEBUG) Log.e(TAG, "HTTP dataPost encoding error: " + e.getMessage());
		} catch (IOException e) {
            if (Lamp.DEBUG) Log.e(TAG, "HTTP dataPost io/null error: " + e.getMessage());
		} catch (IllegalStateException e ) {
            if (Lamp.DEBUG) Log.e(TAG, "HTTP dataPost state error: " + e.getMessage());
		}
        return null;
	}
}
