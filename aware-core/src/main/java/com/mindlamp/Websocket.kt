...
class Websocket : Aware_Sensor() {
    ...
    companion object {
        ...
        lateinit var awareSensor : LAMPSensorObserver

        fun getSensorObserver() : LAMPSensorObserver {
            return awareSensor
        }
    }
    ...
    override fun onCreate() {
        ...
        AsyncHttpClient.getDefaultInstance().websocket(
            Lamp.getSetting(applicationContext, Lamp_Preferences.WEBSOCKET_SERVER), "post",
        ...
        awareSensor = object : LAMPSensorObserver {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        if (PERMISSIONS_OK) {
            DEBUG = Lamp.getSetting(applicationContext, Lamp_Preferences.DEBUG_FLAG) == "true"
            Lamp.setSetting(applicationContext, Lamp_Preferences.STATUS_WEBSOCKET, true)
