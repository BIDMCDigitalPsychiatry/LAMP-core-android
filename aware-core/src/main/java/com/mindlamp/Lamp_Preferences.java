...
/**
 * LAMP Framework core parameters
 *
 * @author denzilferreira
 */
public class Lamp_Preferences {
    ...
    /**
     * Activate/deactive LAMP debug messages (boolean)
     */
    ...
    /**
     * LAMP Group ID, used for assigning clients to a specific research group upon deployment
     */
     ...
     */
    public static final String LAMP_VERSION = "mindlamp_version";

    /**
     * Donate usage data to LAMP project.  Note that this only sends device ID and
     * version information, no actual data of any sort.
     */
    public static final String LAMP_DONATE_USAGE = "mindlamp_donate_usage";
    ...
    /**
     * Activate/deactivate LAMP webservice (boolean)
     */
    ...
    /**
     * LAMP webservice silence: If "true", then don't show a notification when uploading
    ...
    /**
     * Makes LAMP a foreground service
     */
