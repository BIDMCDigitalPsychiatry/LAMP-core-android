...
import com.mindlamp.providers.Applications_Provider.Applications_Crashes;
import com.mindlamp.providers.Applications_Provider.Applications_Foreground;
import com.mindlamp.providers.Applications_Provider.Applications_History;
import com.mindlamp.providers.Applications_Provider.Applications_Notifications;
import com.mindlamp.providers.Keyboard_Provider;
import com.mindlamp.providers.Screen_Provider;
import com.mindlamp.utils.Converters;
import com.mindlamp.utils.Encrypter;
import com.mindlamp.utils.Scheduler;
 ...
 * - ACTION_LAMP_APPLICATIONS_FOREGROUND: new application on the screen
 * - ACTION_LAMP_APPLICATIONS_HISTORY: sync_applications running was just updated
 * - ACTION_LAMP_APPLICATIONS_NOTIFICATIONS: new notification received
 * - ACTION_LAMP_APPLICATIONS_CRASHES: an application crashed, error and ANR conditions
 *
 * @author denzil
 */
public class Applications extends AccessibilityService {

    private static String TAG = "LAMP::Applications";
    private static boolean DEBUG = false;

    public static final String STATUS_LAMP_ACCESSIBILITY = "STATUS_LAMP_ACCESSIBILITY";

    /**
     * Broadcasted event: a new application is visible on the foreground
     */
    public static final String ACTION_LAMP_APPLICATIONS_FOREGROUND = "ACTION_LAMP_APPLICATIONS_FOREGROUND";

    /**
     * Broadcasted event: new foreground and background statistics are available
     */
    public static final String ACTION_LAMP_APPLICATIONS_HISTORY = "ACTION_LAMP_APPLICATIONS_HISTORY";

    /**
     * Broadcasted event: new notification is available
     */
    public static final String ACTION_LAMP_APPLICATIONS_NOTIFICATIONS = "ACTION_LAMP_APPLICATIONS_NOTIFICATIONS";

    /**
     * Broadcasted event: application just crashed
     */
    public static final String ACTION_LAMP_APPLICATIONS_CRASHES = "ACTION_LAMP_APPLICATIONS_CRASHES";
    ...
    public void onAccessibilityEvent(AccessibilityEvent event) {
        ...
        if (Lamp.getSetting(getApplicationContext(), Lamp_Preferences.STATUS_NOTIFICATIONS).equals("true") && event.getEventType() == AccessibilityEvent.TYPE_NOTIFICATION_STATE_CHANGED) {
            Notification notificationDetails = (Notification) event.getParcelableData();
            if (notificationDetails != null) {
                ContentValues rowData = new ContentValues();
                rowData.put(Applications_Notifications.DEVICE_ID, Lamp.getSetting(getApplicationContext(), Lamp_Preferences.DEVICE_ID));
                ...
                Intent notification = new Intent(ACTION_LAMP_APPLICATIONS_NOTIFICATIONS);
                notification.putExtra(EXTRA_DATA, rowData);
                sendBroadcast(notification);
            }
        }

        if (Lamp.getSetting(getApplicationContext(), Lamp_Preferences.STATUS_APPLICATIONS).equals("true") && event.getEventType() == AccessibilityEvent.TYPE_WINDOW_STATE_CHANGED) {
            PackageManager packageManager = getPackageManager();
            ...
            if (!same_app) {
                ...
                rowData.put(Applications_Foreground.DEVICE_ID, Lamp.getSetting(getApplicationContext(), Lamp_Preferences.DEVICE_ID));
                ...
                Intent newForeground = new Intent(ACTION_LAMP_APPLICATIONS_FOREGROUND);
                newForeground.putExtra(EXTRA_DATA, rowData);
                sendBroadcast(newForeground);
            }

            if (Lamp.getSetting(getApplicationContext(), Lamp_Preferences.STATUS_CRASHES).equals("true")) {
                ...
                if (errors != null) {
                    ...
                    while (iter.hasNext()) {
                        ...
                        try {
                            ...
                            crashData.put(Applications_Crashes.DEVICE_ID, Lamp.getSetting(getApplicationContext(), Lamp_Preferences.DEVICE_ID));
                            ...
                            Intent crashed = new Intent(ACTION_LAMP_APPLICATIONS_CRASHES);
        ...
        if (Lamp.getSetting(getApplicationContext(), Lamp_Preferences.STATUS_KEYBOARD).equals("true") && event.getEventType() == AccessibilityEvent.TYPE_VIEW_TEXT_CHANGED) {
            ContentValues keyboard = new ContentValues();
            keyboard.put(Keyboard_Provider.Keyboard_Data.TIMESTAMP, System.currentTimeMillis());
            keyboard.put(Keyboard_Provider.Keyboard_Data.DEVICE_ID, Lamp.getSetting(getApplicationContext(), Lamp_Preferences.DEVICE_ID));
            ...
            if (Lamp.getSetting(getApplicationContext(), Lamp_Preferences.MASK_KEYBOARD).equals("true")) {
            ...
            Intent keyboard_data = new Intent(Keyboard.ACTION_LAMP_KEYBOARD);
            sendBroadcast(keyboard_data);
        }

        if (Lamp.getSetting(getApplicationContext(), Lamp_Preferences.STATUS_TOUCH).equals("true")) {
            if (event.getEventType() == AccessibilityEvent.TYPE_VIEW_SCROLLED) {
                ...
                if (last_scroll_index > 0) {
                    if (event.getFromIndex() < last_scroll_index) {
                        ...
                        touch.put(Screen_Provider.Screen_Touch.DEVICE_ID, Lamp.getSetting(getApplicationContext(), Lamp_Preferences.DEVICE_ID));
                        touch.put(Screen_Provider.Screen_Touch.TOUCH_APP, event.getPackageName().toString());
                        touch.put(Screen_Provider.Screen_Touch.TOUCH_ACTION, Screen.ACTION_LAMP_TOUCH_SCROLLED_UP);
                        ...
                        Intent touch_data = new Intent(Screen.ACTION_LAMP_TOUCH_SCROLLED_UP);
                        ...
                        touch.put(Screen_Provider.Screen_Touch.DEVICE_ID, Lamp.getSetting(getApplicationContext(), Lamp_Preferences.DEVICE_ID));
                        touch.put(Screen_Provider.Screen_Touch.TOUCH_APP, event.getPackageName().toString());
                        touch.put(Screen_Provider.Screen_Touch.TOUCH_ACTION, Screen.ACTION_LAMP_TOUCH_SCROLLED_DOWN);
                        touch.put(Screen_Provider.Screen_Touch.TOUCH_INDEX_ITEMS, event.getItemCount());
                        touch.put(Screen_Provider.Screen_Touch.TOUCH_FROM_INDEX, event.getFromIndex());
                        touch.put(Screen_Provider.Screen_Touch.TOUCH_TO_INDEX, event.getToIndex());
                        ...
                        Intent touch_data = new Intent(Screen.ACTION_LAMP_TOUCH_SCROLLED_DOWN);
                        sendBroadcast(touch_data);
            ...
            if (event.getEventType() == AccessibilityEvent.TYPE_VIEW_CLICKED) {
                ...
                touch.put(Screen_Provider.Screen_Touch.DEVICE_ID, Lamp.getSetting(getApplicationContext(), Lamp_Preferences.DEVICE_ID));
                touch.put(Screen_Provider.Screen_Touch.TOUCH_APP, event.getPackageName().toString());
                touch.put(Screen_Provider.Screen_Touch.TOUCH_ACTION, Screen.ACTION_LAMP_TOUCH_CLICKED);
                if (Lamp.getSetting(getApplicationContext(), Lamp_Preferences.MASK_TOUCH_TEXT).equals("true"))
                ...
                Intent touch_data = new Intent(Screen.ACTION_LAMP_TOUCH_CLICKED);
                sendBroadcast(touch_data);
            }
            ...
            if (event.getEventType() == AccessibilityEvent.TYPE_VIEW_LONG_CLICKED) {
                ...
                touch.put(Screen_Provider.Screen_Touch.DEVICE_ID, Lamp.getSetting(getApplicationContext(), Lamp_Preferences.DEVICE_ID));
                touch.put(Screen_Provider.Screen_Touch.TOUCH_APP, event.getPackageName().toString());
                touch.put(Screen_Provider.Screen_Touch.TOUCH_ACTION, Screen.ACTION_LAMP_TOUCH_LONG_CLICKED);
                if (Lamp.getSetting(getApplicationContext(), Lamp_Preferences.MASK_TOUCH_TEXT).equals("true"))
                    touch.put(Screen_Provider.Screen_Touch.TOUCH_ACTION_TEXT, Converters.maskString(event.getText().toString()));
                else
                    touch.put(Screen_Provider.Screen_Touch.TOUCH_ACTION_TEXT, event.getText().toString());
                ...
                Intent touch_data = new Intent(Screen.ACTION_LAMP_TOUCH_LONG_CLICKED);
                sendBroadcast(touch_data);
            }
        }
    }
    ...
    protected void onServiceConnected() {
        ...
        Lamp.startScheduler(this);

        DEBUG = Lamp.getSetting(this, Lamp_Preferences.DEBUG_FLAG).equals("true");
        TAG = Lamp.getSetting(this, Lamp_Preferences.DEBUG_TAG);

        if (DEBUG) Log.d(Lamp.TAG, "Aware service connected to accessibility services...");

        //This makes sure that plugins and apps can check if the accessibility service is active
        Lamp.setSetting(this, Applications.STATUS_LAMP_ACCESSIBILITY, true);

        IntentFilter webservices = new IntentFilter();
        webservices.addAction(Lamp.ACTION_LAMP_SYNC_DATA);
        registerReceiver(awareMonitor, webservices);

        if (Lamp.getSetting(getApplicationContext(), Lamp_Preferences.FOREGROUND_PRIORITY).equals("true")) {
            sendBroadcast(new Intent(Lamp.ACTION_LAMP_PRIORITY_FOREGROUND));
        }

        if (Lamp.getSetting(getApplicationContext(), Lamp_Preferences.FREQUENCY_APPLICATIONS).length() == 0) {
            Lamp.setSetting(getApplicationContext(), Lamp_Preferences.FREQUENCY_APPLICATIONS, 0);
        }

        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP && Lamp.getSetting(getApplicationContext(), Lamp_Preferences.STATUS_APPLICATIONS).equals("true") && Integer.parseInt(Lamp.getSetting(getApplicationContext(), Lamp_Preferences.FREQUENCY_APPLICATIONS)) > 0) {
            try {
                ...
                if (backgroundApps == null) {
                    backgroundApps = new Scheduler.Schedule(SCHEDULER_APPLICATIONS_BACKGROUND)
                            .setInterval(Long.parseLong(Lamp.getSetting(getApplicationContext(), Lamp_Preferences.FREQUENCY_APPLICATIONS)))
                            .setActionIntentAction(ACTION_LAMP_APPLICATIONS_HISTORY)
                            .setActionType(Scheduler.ACTION_TYPE_SERVICE)
                            .setActionClass(getPackageName() + "/" + BackgroundService.class.getName());

                    Scheduler.saveSchedule(this, backgroundApps);
                } else {
                    if (backgroundApps.getInterval() != Long.parseLong(Lamp.getSetting(this, Lamp_Preferences.FREQUENCY_APPLICATIONS))) {
                        backgroundApps.setInterval(Long.parseLong(Lamp.getSetting(this, Lamp_Preferences.FREQUENCY_APPLICATIONS)));
                        Scheduler.saveSchedule(this, backgroundApps);
                    }
                }
        ...
        if (Lamp.isStudy(this)) {
            ContentResolver.setIsSyncable(Lamp.getLAMPAccount(this), Applications_Provider.getAuthority(this), 1);
            ContentResolver.setSyncAutomatically(Lamp.getLAMPAccount(this), Applications_Provider.getAuthority(this), true);

            long frequency = Long.parseLong(Lamp.getSetting(this, Lamp_Preferences.FREQUENCY_WEBSERVICE)) * 60;
            SyncRequest request = new SyncRequest.Builder()
                    .syncPeriodic(frequency, frequency / 3)
                    .setSyncAdapter(Lamp.getLAMPAccount(this), Applications_Provider.getAuthority(this))
    ...
    public void onInterrupt() {
        if (Lamp.getSetting(getApplicationContext(), Applications.STATUS_LAMP_ACCESSIBILITY).equals("true")) {
            try {
    ...
    public boolean onUnbind(Intent intent) {
        ...
        Lamp.setSetting(this, Applications.STATUS_LAMP_ACCESSIBILITY, false);
        Scheduler.removeSchedule(this, SCHEDULER_APPLICATIONS_BACKGROUND);

        //notify the user
        Applications.isAccessibilityServiceActive(getApplicationContext());

        ContentResolver.setSyncAutomatically(Lamp.getLAMPAccount(this), Applications_Provider.getAuthority(this), false);
    ...
    /**
     * Received LAMP broadcasts
     * - ACTION_LAMP_SYNC_DATA
     *
     * @author df
     */
    ...
    public class ContextBroadcaster extends WakefulBroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals(Lamp.ACTION_LAMP_SYNC_DATA) && AUTHORITY.length() > 0) {
                Bundle sync = new Bundle();
                sync.putBoolean(ContentResolver.SYNC_EXTRAS_MANUAL, true);
                sync.putBoolean(ContentResolver.SYNC_EXTRAS_EXPEDITED, true);
                ContentResolver.requestSync(Lamp.getLAMPAccount(context), AUTHORITY, sync);
            }
        }
    }
    ...
    private static Applications.LAMPSensorObserver awareSensor;

    public static void setSensorObserver(Applications.LAMPSensorObserver observer) {
        awareSensor = observer;
    }

    public static Applications.LAMPSensorObserver getSensorObserver() {
        return awareSensor;
    }
    ...
    private synchronized static boolean isAccessibilityEnabled(Context context) {
        ...
        Lamp.setSetting(context, Applications.STATUS_LAMP_ACCESSIBILITY, enabled, "com.aware.phone");

        return enabled;
    }

    /**
     * Check if the accessibility service for LAMP Aware is active
     *
     * @return boolean isActive
     */
    public synchronized static boolean isAccessibilityServiceActive(Context c) {
        if (!isAccessibilityEnabled(c)) {
            NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(c, Lamp.LAMP_NOTIFICATION_CHANNEL_GENERAL);
    ...
    public static class BackgroundService extends IntentService {
        ...
        protected void onHandleIntent(Intent intent) {
            ...
            if (!Lamp.getSetting(getApplicationContext(), Lamp_Preferences.STATUS_APPLICATIONS).equals("true")) {
                Scheduler.removeSchedule(getApplicationContext(), SCHEDULER_APPLICATIONS_BACKGROUND);
                if (DEBUG)
            ...
            if (Lamp.getSetting(getApplicationContext(), Lamp_Preferences.STATUS_APPLICATIONS).equals("true") && intent.getAction().equals(ACTION_LAMP_APPLICATIONS_HISTORY)) {
                ...
                for (RunningAppProcessInfo app : runningApps) {
                    try {
                        ...
                        if (appUnclosed == null || !appUnclosed.moveToFirst()) {
                            ...
                            rowData.put(Applications_History.DEVICE_ID, Lamp.getSetting(getApplicationContext(), Lamp_Preferences.DEVICE_ID));
                ...
                Intent statsUpdated = new Intent(ACTION_LAMP_APPLICATIONS_HISTORY);
