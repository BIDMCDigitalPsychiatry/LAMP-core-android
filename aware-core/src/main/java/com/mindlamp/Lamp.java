...
public class Lamp extends Service {
    ...
    public static Account getLAMPAccount(Context context) {
        ...
        Account[] accounts = accountManager.getAccountsByType(Aware_Accounts.Aware_Account.LAMP_ACCOUNT_TYPE);
        if (accounts.length > 0) {
            aware_account = accounts[0];
            return aware_account;
        }
        if (aware_account == null) {
            aware_account = new Account(Aware_Accounts.Aware_Account.LAMP_ACCOUNT, Aware_Accounts.Aware_Account.LAMP_ACCOUNT_TYPE);
            try {
