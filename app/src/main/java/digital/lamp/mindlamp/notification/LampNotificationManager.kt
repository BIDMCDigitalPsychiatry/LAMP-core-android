...
object LampNotificationManager {
     ...
     * @param actionList list of notification action
     */
    ...
    /**
     * Shows a notification with action Open App.
     *
     * @param context The application context.
     * @param remoteMessage The message to display in the notification.
     */
    ...
    /**
     * Shows a notification for a specific activity schedule.
     *
     * @param context The application context.
     * @param oActivitySchedule The activity schedule for which the notification is shown.
     * @param localNotificationId The local identifier for the notification.
     */
