...
import com.mindlamp.providers.Installations_Provider;
import com.mindlamp.providers.Installations_Provider.Installations_Data;
import com.mindlamp.utils.Lamp_Sensor;

/**
 * Service that logs application installations on the device.
 * - ACTION_LAMP_APPLICATION_ADDED : new application installed
 * - ACTION_LAMP_APPLICATION_REMOVED: application removed
 * - ACTION_LAMP_APPLICATION_UPDATED: application updated
 *
 * @author denzil
 */

public class Installations extends Lamp_Sensor {

    private static String TAG = "LAMP::Installations";

    /**
     * Broadcasted event: new application has been installed
     * Extra: package_name, application_name
     */
    public static final String ACTION_LAMP_APPLICATION_ADDED = "ACTION_LAMP_APPLICATION_ADDED";

    /**
     * Broadcasted event: an existing application has been removed
     * Extra: package_name, application_name
     */
    public static final String ACTION_LAMP_APPLICATION_REMOVED = "ACTION_LAMP_APPLICATION_REMOVED";

    /**
     * Broadcasted event: an existing application has been updated
     * Extra: package_name, application_name
     */
    public static final String ACTION_LAMP_APPLICATION_UPDATED = "ACTION_LAMP_APPLICATION_UPDATED";
    ...
    public void onCreate() {
        ...
        CONTEXT_PRODUCER = new Lamp_Sensor.ContextProducer() {
            @Override
        ...
        if (Lamp.DEBUG) Log.d(TAG, "Installations service created!");
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (PERMISSIONS_OK) {
            ...
            Lamp.setSetting(this, Lamp_Preferences.STATUS_INSTALLATIONS, true);

            if (Lamp.DEBUG) Log.d(TAG, "Installations service active...");

            if (Lamp.isStudy(this)) {
                ContentResolver.setIsSyncable(Lamp.getLAMPAccount(this), Installations_Provider.getAuthority(this), 1);
                ContentResolver.setSyncAutomatically(Lamp.getLAMPAccount(this), Installations_Provider.getAuthority(this), true);
                long frequency = Long.parseLong(Lamp.getSetting(this, Lamp_Preferences.FREQUENCY_WEBSERVICE)) * 60;
                SyncRequest request = new SyncRequest.Builder()
                        .syncPeriodic(frequency, frequency / 3)
                        .setSyncAdapter(Lamp.getLAMPAccount(this), Installations_Provider.getAuthority(this))
    ...
    public void onDestroy() {
        ...
        ContentResolver.setSyncAutomatically(Lamp.getLAMPAccount(this), Installations_Provider.getAuthority(this), false);
        ...
        if (Lamp.DEBUG) Log.d(TAG, "Installations service terminated...");
    }
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (Lamp.getSetting(context, Lamp_Preferences.STATUS_INSTALLATIONS).equals("true")) {
                ...
                if (intent.getAction().equals(Intent.ACTION_PACKAGE_ADDED)) {
                    ...
                    rowData.put(Installations_Data.DEVICE_ID, Lamp.getSetting(context, Lamp_Preferences.DEVICE_ID));
                    ...
                    try {
                        ...
                        current_context = ACTION_LAMP_APPLICATION_ADDED;
                ...
                if (intent.getAction().equals(Intent.ACTION_PACKAGE_REMOVED)) {
                    ...
                    try {
                        ...
                        package_name = packageName;
                        application_name = appName;
                        current_context = ACTION_LAMP_APPLICATION_REMOVED;
                        sContext_producer.onContext();
                ...
                if (intent.getAction().equals(Intent.ACTION_PACKAGE_REPLACED)) {
                    ...
                    try {
                        ...
                        package_name = packageName;
                        application_name = appName;
                        current_context = ACTION_LAMP_APPLICATION_UPDATED;
                        sContext_producer.onContext();
