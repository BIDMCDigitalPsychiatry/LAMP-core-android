...
public class PermissionsHandler extends Activity {
     ...
     */
    public static final String ACTION_LAMP_PERMISSIONS_CHECK = "ACTION_LAMP_PERMISSIONS_CHECK";
    ...
    protected void onResume() {
        ...
        if (getIntent() != null && getIntent().getExtras() != null && getIntent().getSerializableExtra(EXTRA_REQUIRED_PERMISSIONS) != null) {
            ...
            if (getIntent().hasExtra(EXTRA_REDIRECT_ACTIVITY)) {
                ...
                redirect_service.setAction(ACTION_LAMP_PERMISSIONS_CHECK);
        ...
        if (requestCode == RC_PERMISSIONS) {
            ...
            for (int i = 0; i < permissions.length; i++) {
                if (grantResults[i] != PackageManager.PERMISSION_GRANTED) {
                    not_granted++;
                    Log.d(Lamp.TAG, permissions[i] + " was not granted");
                } else {
                    Log.d(Lamp.TAG, permissions[i] + " was granted");
                }
            }
