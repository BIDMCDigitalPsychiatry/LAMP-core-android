...
public class Lamp_TTS extends Service implements OnInitListener {

    public static final String ACTION_LAMP_TTS_SPEAK = "ACTION_LAMP_TTS_SPEAK";

    private static final String TAG = "LAMP::TTS";
    ...
    public void onCreate() {
        ...
        filter.addAction(ACTION_LAMP_TTS_SPEAK);
    ...
    public static class Aware_TTS_Receiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if( intent.getAction().equals(ACTION_LAMP_TTS_SPEAK) && intent.getStringExtra(EXTRA_TTS_REQUESTER).equals(context.getPackageName()) ) {
                Intent tts_work = new Intent( context, Lamp_TTS.class );
