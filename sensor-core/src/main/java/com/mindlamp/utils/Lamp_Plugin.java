 ...
 * @author denzil
 */
public class Lamp_Plugin extends Service {

    /**
     * Debug tag for this plugin
     */
    public String TAG = "LAMP Plugin";
    ...
    public void onCreate() {
        ...
        filter.addAction(Lamp.ACTION_LAMP_STOP_PLUGINS);
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (!PERMISSIONS_OK) {
            ...
            if (Lamp.getSetting(this, Lamp_Preferences.STATUS_WEBSERVICE).equals("true")) {
                SSLManager.handleUrl(getApplicationContext(), Lamp.getSetting(this, Lamp_Preferences.WEBSERVICE_SERVER), true);
            }

            //Restores core LAMP service in case it get's killed
            if (!Lamp.IS_CORE_RUNNING) {
                Intent aware = new Intent(getApplicationContext(), Lamp.class);
                startService(aware);
            }

            //Aware.startLAMP(getApplicationContext());
    ...
    public void onDestroy() {
        ...
        if (PERMISSIONS_OK) {
            ...
            Lamp.stopLAMP(getApplicationContext());
        }
     ...
     * - ACTION_LAMP_STOP_PLUGINS: stops this plugin
     * - ACTION_LAMP_SYNC_DATA: sends the data to the server
     * @author denzil
     */
    public static class ContextBroadcaster extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction().equals(Lamp.ACTION_LAMP_STOP_PLUGINS)) {
