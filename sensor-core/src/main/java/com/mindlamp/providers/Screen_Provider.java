...
/**
 * LAMP Screen Content Provider Allows you to access all the recorded screen
 * events on the database Database is located at the SDCard : /LAMP/screen.db
 *
 * @author denzil
 */
public class Screen_Provider extends ContentProvider {
     ...
     */
    public static String AUTHORITY = "com.mindlamp.provider.screen";
