...
/**
 * LAMP Bluetooth Content Provider Allows you to access all the recorded
...
public class Bluetooth_Provider extends ContentProvider {
     ...
     * com.mindlamp.provider.bluetooth
     */
    public static String AUTHORITY = "com.mindlamp.provider.bluetooth";
