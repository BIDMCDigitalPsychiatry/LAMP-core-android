...
import com.mindlamp.providers.Network_Provider;
import com.mindlamp.providers.Network_Provider.Network_Data;
 ...
 * @author denzil
 */
public class Network extends Lamp_Sensor {

    private static String TAG = "LAMP::Network";
     ...
     */
    public static final String ACTION_LAMP_AIRPLANE_ON = "ACTION_LAMP_AIRPLANE_ON";

    /**
     * Broadcasted event: airplane is inactive
     */
    public static final String ACTION_LAMP_AIRPLANE_OFF = "ACTION_LAMP_AIRPLANE_OFF";

    /**
     * Broadcasted event: wifi is active
     */
    public static final String ACTION_LAMP_WIFI_ON = "ACTION_LAMP_WIFI_ON";

    /**
     * Broadcasted event: wifi is inactive
     */
    public static final String ACTION_LAMP_WIFI_OFF = "ACTION_LAMP_WIFI_OFF";

    /**
     * Broadcasted event: mobile is active
     */
    public static final String ACTION_LAMP_MOBILE_ON = "ACTION_LAMP_MOBILE_ON";

    /**
     * Broadcasted event: mobile is inactive
     */
    public static final String ACTION_LAMP_MOBILE_OFF = "ACTION_LAMP_MOBILE_OFF";

    /**
     * Broadcasted event: wimax is active
     */
    public static final String ACTION_LAMP_WIMAX_ON = "ACTION_LAMP_WIMAX_ON";

    /**
     * Broadcasted event: wimax is inactive
     */
    public static final String ACTION_LAMP_WIMAX_OFF = "ACTION_LAMP_WIMAX_OFF";

    /**
     * Broadcasted event: bluetooth is active
     */
    public static final String ACTION_LAMP_BLUETOOTH_ON = "ACTION_LAMP_BLUETOOTH_ON";

    /**
     * Broadcasted event: bluetooth is inactive
     */
    public static final String ACTION_LAMP_BLUETOOTH_OFF = "ACTION_LAMP_BLUETOOTH_OFF";

    /**
     * Broadcasted event: GPS is active
     */
    public static final String ACTION_LAMP_GPS_ON = "ACTION_LAMP_GPS_ON";

    /**
     * Broadcasted event: GPS is inactive
     */
    public static final String ACTION_LAMP_GPS_OFF = "ACTION_LAMP_GPS_OFF";

    /**
     * Broadcasted event: internet access is available
     */
    public static final String ACTION_LAMP_INTERNET_AVAILABLE = "ACTION_LAMP_INTERNET_AVAILABLE";

    /**
     * Broadcasted event: internet access is unavailable
     */
    public static final String ACTION_LAMP_INTERNET_UNAVAILABLE = "ACTION_LAMP_INTERNET_UNAVAILABLE";
    ...
    /**
     * Extra for ACTION_LAMP_INTERNET_AVAILABLE
    ...
    private static Network.LAMPSensorObserver awareSensor;

    public static void setSensorObserver(Network.LAMPSensorObserver observer) {
        awareSensor = observer;
    }

    public static Network.LAMPSensorObserver getSensorObserver() {
        return awareSensor;
    }
    ...
    private PhoneStateListener phoneListener = new PhoneStateListener() {
        public void onServiceStateChanged(android.telephony.ServiceState serviceState) {
            if (serviceState.getState() == ServiceState.STATE_POWER_OFF) {
                ...
                mobile.put(Network_Data.DEVICE_ID, Lamp.getSetting(getApplicationContext(), Lamp_Preferences.DEVICE_ID));
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction().equals(LocationManager.PROVIDERS_CHANGED_ACTION)) {
                if (locationManager.isProviderEnabled(LocationManager.GPS_PROVIDER)) {
                    ...
                    started.put(Network_Data.DEVICE_ID, Lamp.getSetting(context, Lamp_Preferences.DEVICE_ID));
                    ...
                    stopped.put(Network_Data.DEVICE_ID, Lamp.getSetting(context, Lamp_Preferences.DEVICE_ID));
            ...
            if (intent.getAction().equals(Intent.ACTION_AIRPLANE_MODE_CHANGED)) {
                ...
                if (is_airplane) {
                    ...
                    rowData.put(Network_Data.DEVICE_ID, Lamp.getSetting(context, Lamp_Preferences.DEVICE_ID));
            ...
            if (intent.getAction().equals(WifiManager.WIFI_STATE_CHANGED_ACTION)) {
                ...
                if (wifi_state == WifiManager.WIFI_STATE_ENABLED) {
                    ...
                    data.put(Network_Data.DEVICE_ID, Lamp.getSetting(context, Lamp_Preferences.DEVICE_ID));
            ...
            if (intent.getAction().equals(ConnectivityManager.CONNECTIVITY_ACTION)) {
                ...
                if (internet == null) {
                    ...
                    if (Lamp.DEBUG) Log.d(TAG, ACTION_LAMP_INTERNET_UNAVAILABLE);
                    Intent not_available = new Intent(ACTION_LAMP_INTERNET_UNAVAILABLE);
                    context.sendBroadcast(not_available);
                } else {

                    if (awareSensor != null) awareSensor.onInternetON();

                    if (Lamp.DEBUG) Log.d(TAG, ACTION_LAMP_INTERNET_AVAILABLE);
                    Intent available = new Intent(ACTION_LAMP_INTERNET_AVAILABLE);
    ...
    public void onCreate() {
        ...
        if (Lamp.DEBUG) Log.d(TAG, "Network service created...");
    }
    ...
    public void onDestroy() {
        ...
        ContentResolver.setSyncAutomatically(Lamp.getLAMPAccount(this), Network_Provider.getAuthority(this), false);
        ...
        if (Lamp.DEBUG) Log.d(TAG, "Network service terminated...");
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (PERMISSIONS_OK) {
            ...
            Lamp.setSetting(this, Lamp_Preferences.STATUS_NETWORK_EVENTS, true);
