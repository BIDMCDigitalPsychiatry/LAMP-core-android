...
import com.mindlamp.providers.Bluetooth_Provider.Bluetooth_Data;
import com.mindlamp.providers.Bluetooth_Provider.Bluetooth_Sensor;
 ...
 * @author denzil
 */
public class Bluetooth extends Lamp_Sensor {

    private static String TAG = "LAMP::Bluetooth";
     ...
     */
    public static final String ACTION_LAMP_BLUETOOTH_NEW_DEVICE = "ACTION_LAMP_BLUETOOTH_NEW_DEVICE";
    public static final String ACTION_LAMP_BLUETOOTH_NEW_DEVICE_BLE = "ACTION_LAMP_BLUETOOTH_NEW_DEVICE_BLE";
    public static final String EXTRA_DEVICE = "extra_device";

    /**
     * Broadcasted event: bluetooth scan started
     */
    public static final String ACTION_LAMP_BLUETOOTH_SCAN_STARTED = "ACTION_LAMP_BLUETOOTH_SCAN_STARTED";
    public static final String ACTION_LAMP_BLUETOOTH_BLE_SCAN_STARTED = "ACTION_LAMP_BLUETOOTH_BLE_SCAN_STARTED";

    /**
     * Broadcasted event: bluetooth scan ended
     */
    public static final String ACTION_LAMP_BLUETOOTH_SCAN_ENDED = "ACTION_LAMP_BLUETOOTH_SCAN_ENDED";
    public static final String ACTION_LAMP_BLUETOOTH_BLE_SCAN_ENDED = "ACTION_LAMP_BLUETOOTH_BLE_SCAN_ENDED";

    /**
     * Broadcast receiving event: request a bluetooth scan
     */
    public static final String ACTION_LAMP_BLUETOOTH_REQUEST_SCAN = "ACTION_LAMP_BLUETOOTH_REQUEST_SCAN";
     ...
     */
    private static String ACTION_LAMP_ENABLE_BT = "ACTION_LAMP_ENABLE_BT";
    ...
    public void onCreate() {
        ...
        filter.addAction(Bluetooth.ACTION_LAMP_BLUETOOTH_REQUEST_SCAN);
        ...
        Intent backgroundService = new Intent(ACTION_LAMP_BLUETOOTH_REQUEST_SCAN);
        ...
        enableBT.putExtra("action", ACTION_LAMP_ENABLE_BT);

        if (Lamp.DEBUG) Log.d(TAG, "Bluetooth service created!");
    }

    private static Bluetooth.LAMPSensorObserver awareSensor;

    public static void setSensorObserver(Bluetooth.LAMPSensorObserver observer) {
        awareSensor = observer;
    }

    public static Bluetooth.LAMPSensorObserver getSensorObserver() {
        return awareSensor;
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (PERMISSIONS_OK) {
            if (intent != null && intent.hasExtra("action") && intent.getStringExtra("action").equalsIgnoreCase(ACTION_LAMP_ENABLE_BT)) {
            ...
            if (bluetoothAdapter == null) {
                if (Lamp.DEBUG) Log.w(TAG, "No bluetooth is detected on this device");
                stopSelf();
            } else {
                ...
                Lamp.setSetting(this, Lamp_Preferences.STATUS_BLUETOOTH, true);

                if (Lamp.getSetting(this, Lamp_Preferences.FREQUENCY_BLUETOOTH).length() == 0) {
                    Lamp.setSetting(this, Lamp_Preferences.FREQUENCY_BLUETOOTH, 60);
                }

                save_bluetooth_device(bluetoothAdapter);

                if (FREQUENCY != Integer.parseInt(Lamp.getSetting(getApplicationContext(), Lamp_Preferences.FREQUENCY_BLUETOOTH))) {
                    alarmManager.cancel(bluetoothScan);
                    alarmManager.setRepeating(AlarmManager.RTC_WAKEUP,
                            System.currentTimeMillis() + Integer.parseInt(Lamp.getSetting(getApplicationContext(), Lamp_Preferences.FREQUENCY_BLUETOOTH)) * 1000,
                            Integer.parseInt(Lamp.getSetting(getApplicationContext(), Lamp_Preferences.FREQUENCY_BLUETOOTH)) * 2 * 1000,
                            bluetoothScan);

                    FREQUENCY = Integer.parseInt(Lamp.getSetting(getApplicationContext(), Lamp_Preferences.FREQUENCY_BLUETOOTH));
                }
                if (Lamp.DEBUG) Log.d(TAG, "Bluetooth service active: " + FREQUENCY + "s");
            ...
            if (Lamp.isStudy(this)) {
                ContentResolver.setIsSyncable(Lamp.getLAMPAccount(this), Bluetooth_Provider.getAuthority(this), 1);
                ContentResolver.setSyncAutomatically(Lamp.getLAMPAccount(this), Bluetooth_Provider.getAuthority(this), true);

                long frequency = Long.parseLong(Lamp.getSetting(this, Lamp_Preferences.FREQUENCY_WEBSERVICE)) * 60;
                SyncRequest request = new SyncRequest.Builder()
                        .syncPeriodic(frequency, frequency / 3)
                        .setSyncAdapter(Lamp.getLAMPAccount(this), Bluetooth_Provider.getAuthority(this))
    ...
    private Runnable scanRunnable = new Runnable() {
        ...
        public void run() {
            ...
            if (scanner != null && !isBLEScanning) {
                ...
                if (Lamp.DEBUG) Log.d(TAG, ACTION_LAMP_BLUETOOTH_BLE_SCAN_STARTED);
                Intent scanStart = new Intent(ACTION_LAMP_BLUETOOTH_BLE_SCAN_STARTED);
    ...
    private Runnable stopScan = new Runnable() {
        ...
        public void run() {
            ...
            if (scanner != null && isBLEScanning) {
                ...
                if (Lamp.DEBUG) Log.d(TAG, ACTION_LAMP_BLUETOOTH_BLE_SCAN_ENDED);
                Intent scanEnd = new Intent(ACTION_LAMP_BLUETOOTH_BLE_SCAN_ENDED);
    ...
    private final ScanCallback scanCallback = new ScanCallback() {
        ...
        public void onScanResult(int callbackType, ScanResult result) {
            ...
            rowData.put(Bluetooth_Data.DEVICE_ID, Lamp.getSetting(getApplicationContext(), Lamp_Preferences.DEVICE_ID));
            ...
            if (Lamp.DEBUG)
                Log.d(Lamp.TAG, ACTION_LAMP_BLUETOOTH_NEW_DEVICE_BLE + ": " + rowData.toString());

            Intent detectedBT = new Intent(ACTION_LAMP_BLUETOOTH_NEW_DEVICE_BLE);
    ...
    public void onDestroy() {
        ...
        if (bluetoothAdapter != null) {
            ...
            ContentResolver.setSyncAutomatically(Lamp.getLAMPAccount(this), Bluetooth_Provider.getAuthority(this), false);
        ...
        if (Lamp.DEBUG) Log.d(TAG, "Bluetooth service terminated...");
    }
     ...
     * - ACTION_LAMP_BLUETOOTH_REQUEST_SCAN: request a bluetooth scan
     ...
     * - ACTION_LAMP_WEBSERVICE: request for webservice remote backup
     *
     * @author denzil
     */
    public class Bluetooth_Broadcaster extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals(BluetoothDevice.ACTION_FOUND)) {
                ...
                ContentValues rowData = new ContentValues();
                rowData.put(Bluetooth_Data.DEVICE_ID, Lamp.getSetting(context, Lamp_Preferences.DEVICE_ID));
                rowData.put(Bluetooth_Data.TIMESTAMP, System.currentTimeMillis());
                ...
                if (Lamp.DEBUG)
                    Log.d(Lamp.TAG, ACTION_LAMP_BLUETOOTH_NEW_DEVICE + ": " + rowData.toString());

                Intent detectedBT = new Intent(ACTION_LAMP_BLUETOOTH_NEW_DEVICE);
                detectedBT.putExtra(EXTRA_DEVICE, rowData);
            ...
            if (intent.getAction().equals(BluetoothAdapter.ACTION_DISCOVERY_FINISHED)) {
                ...
                if (Lamp.DEBUG) Log.d(TAG, ACTION_LAMP_BLUETOOTH_SCAN_ENDED);
                Intent scanEnd = new Intent(ACTION_LAMP_BLUETOOTH_SCAN_ENDED);
            ...
            if (intent.getAction().equals(BluetoothAdapter.ACTION_DISCOVERY_STARTED)) {
                ...
                if (Lamp.DEBUG) Log.d(TAG, ACTION_LAMP_BLUETOOTH_SCAN_STARTED);
                Intent scanStart = new Intent(ACTION_LAMP_BLUETOOTH_SCAN_STARTED);
            ...
            if (intent.getAction().equals(ACTION_LAMP_BLUETOOTH_REQUEST_SCAN)) {
                ...
                if (!bluetoothAdapter.isDiscovering()) {
                    if (bluetoothAdapter.isEnabled()) {
                        ...
                        //Bluetooth is off
                        if (Lamp.DEBUG) Log.d(TAG, "Bluetooth is turned off...");
                        ContentValues rowData = new ContentValues();
                        rowData.put(Bluetooth_Data.DEVICE_ID, Lamp.getSetting(context, Lamp_Preferences.DEVICE_ID));
                        rowData.put(Bluetooth_Data.TIMESTAMP, System.currentTimeMillis());
    ...
    private void save_bluetooth_device(BluetoothAdapter btAdapter) {
        ...
        if (sensorBT == null || !sensorBT.moveToFirst()) {
            ...
            rowData.put(Bluetooth_Sensor.DEVICE_ID, Lamp.getSetting(getApplicationContext(), Lamp_Preferences.DEVICE_ID));
            ...
            if (Lamp.DEBUG) Log.d(TAG, "Bluetooth local information: " + rowData.toString());
        }
    ...
    private static void notifyMissingBluetooth(Context c, boolean dismiss) {
        if (!dismiss) {
            ...
            NotificationCompat.Builder builder = new NotificationCompat.Builder(c, Lamp.LAMP_NOTIFICATION_CHANNEL_GENERAL)
                    .setSmallIcon(R.drawable.ic_stat_aware_accessibility)
                    .setContentTitle("LAMP: Bluetooth needed")
            ...
            builder = Lamp.setNotificationProperties(builder, Lamp.LAMP_NOTIFICATION_IMPORTANCE_GENERAL);

            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O)
                builder.setChannelId(Lamp.LAMP_NOTIFICATION_CHANNEL_GENERAL);
