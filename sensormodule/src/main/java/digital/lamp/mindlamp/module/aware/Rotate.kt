    ...
    init {
        try {
            ...
            Rotation.setSensorObserver {
                x = it.getAsDouble(Rotation_Provider.Rotation_Data.VALUES_0)?: 0.0
                y = it.getAsDouble(Rotation_Provider.Rotation_Data.VALUES_1)?: 0.0
                z = it.getAsDouble(Rotation_Provider.Rotation_Data.VALUES_2)?: 0.0
                //val value=it.
                if (it != null) {
                    val rotationData =
                        RotationData(x, y, z)
