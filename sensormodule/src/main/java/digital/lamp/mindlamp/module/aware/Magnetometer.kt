    ...
    init {
        try {
            ...
            Magnetometer.setSensorObserver {
                 x = it.getAsDouble(Magnetometer_Provider.Magnetometer_Data.VALUES_0)?: 0.0
                 y = it.getAsDouble(Magnetometer_Provider.Magnetometer_Data.VALUES_1)?: 0.0
                 z = it.getAsDouble(Magnetometer_Provider.Magnetometer_Data.VALUES_2)?: 0.0
                //val value=it.
                if (it != null) {
                    val magnetData =
                        MagnetData(x, y, z)
